...
def mainModel(pretrainedWeights=None):
    ...
    layer1Conv2=ke.layers.Dropout(dropout)(layer1Conv2)
    ...
    layer2Conv2=ke.layers.Dropout(dropout)(layer2Conv2)
    ...
    layer3Conv2=ke.layers.Dropout(dropout)(layer3Conv2)
    ...
    layer4Conv2=ke.layers.Dropout(dropout)(layer4Conv2)
    ...
    layer5Conv2=ke.layers.Dropout(dropout)(layer5Conv2)
    ...
    layer6Conv2=ke.layers.Dropout(dropout)(layer6Conv2)
    ...
    layer7Conv2=ke.layers.Dropout(dropout)(layer7Conv2)
    ...
    layer8Conv2=ke.layers.Dropout(dropout)(layer8Conv2)
    ...
    layer9Conv2=ke.layers.Dropout(dropout)(layer9Conv2)
